...
document.body.innerHTML+='<div class="container-fluid px-5"><h2 class="text-center mt-3">Stats</h2><h4 class="text-center">-<br>Stay: <span id="stay"></span><br>Switch: <span id="switch"></span><br>-</h4></div><h6>Check out my other projects on <a href="https://github.com/zbbright">GitHub,</a> or take a look at my <a href="https://zbbright.github.io/portfolio">portfolio</a>!</h6>';
